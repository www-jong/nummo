  ...
  return (
    ...
    >
      ...
      <div className="justify-self-end min-w-0 text-xs font-mono flex items-center gap-2 sm:gap-2.5">
        {/* GitHub 저장소 링크 */}
        <a
          href="https://github.com/www-jong/nummo"
          target="_blank"
          rel="noopener noreferrer"
          title="GitHub 저장소"
          aria-label="GitHub 저장소 바로가기"
          className="min-h-9 p-2 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 text-neutral-600 dark:text-neutral-400 hover:text-neutral-950 dark:hover:text-neutral-100 hover:border-neutral-300 dark:hover:border-neutral-700 transition-all active:scale-95 shadow-sm inline-flex items-center justify-center"
        >
